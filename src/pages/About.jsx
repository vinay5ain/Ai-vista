    ...
    <div className="space-y-20">
      <header className="max-w-3xl">
        ...
        <h1 className="mt-3 font-display text-4xl font-extrabold tracking-tight text-[var(--color-ink)] sm:text-5xl">
          Community for learners, <span className="gradient-text">by learners</span>
        </h1>
        <p className="mt-4 text-lg text-[var(--color-ink-muted)]">
          AI VISTAAR connects students, self-learners, and educators in one gentle, energetic space—focused on
          growth, not gatekeeping.
        </p>
      </header>
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <Card className="border-purple-500/20 bg-gradient-to-br from-blue-600/5 via-purple-600/5 to-pink-500/5">
          ...
          <h2 className="mt-2 font-display text-2xl font-bold text-[var(--color-ink)]">Make AI learning social</h2>
          <p className="mt-3 text-sm leading-relaxed text-[var(--color-ink-muted)]">
            We host discussions, events, and peer mentorship so learners ages 12–30 can explore responsibly—
            with room to ask “obvious” questions and celebrate small wins.
          </p>
        </Card>
        <Card className="border-pink-500/20 bg-gradient-to-br from-pink-500/5 via-purple-600/5 to-blue-600/5">
          ...
          <h2 className="mt-2 font-display text-2xl font-bold text-[var(--color-ink)]">A vibgyor of pathways</h2>
          <p className="mt-3 text-sm leading-relaxed text-[var(--color-ink-muted)]">
            Just like light splits into many colors, AI learning isn’t one lane. We want many routes—ethical,
            creative, technical—illuminated side by side.
          </p>
        </Card>
      </section>
